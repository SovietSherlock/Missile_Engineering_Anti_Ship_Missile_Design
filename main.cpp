...
int main()
{
	...
	//Формируем структуры исходных данных
	...
	inits.v_c0 = 600.0;				//скорость цели, м/с
	inits.x_g_c0 = 1000.0;			//координата цели, м
    inits.y_g_c0 = 4000.0;			//координата цели, м
	...
	limits.t_r_max = 10.0;            //максимальное время полёта ракеты, с
