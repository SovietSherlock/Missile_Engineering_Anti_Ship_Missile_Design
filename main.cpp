...
int main()
{
	...
	inits.v_c0 = v_c0_knots * 0.514444;		//скорость цели типа "Фрегат", м/с
    ...
    inits.v_r0 = std::nan("");	   // скорость ракеты, м/с
	inits.v_r_min = 200.0;         // минимальная скорость ракеты на подлете к цели, м/с
